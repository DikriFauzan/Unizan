...
export const APP_VERSION = "7.1.0-Unleashed"; 
...
export const DEFAULT_GAME_PORTS: GameEndpoint[] = [
    ...
    { id: 'p2', name: 'Game Telemetry', port: '8091', type: 'telemetry', status: 'active' },
];

export const INITIAL_ROOMS = [
  { id: 'admin-ai', name: 'FEAC BRAIN (v7.1)', type: 'ai', unreadCount: 0, status: 'online', icon: 'brain' },
  { id: 'feac-conversation', name: 'General Chat', type: 'ai', unreadCount: 0, status: 'online', icon: 'message-circle' },
  { id: 'neo-bridge', name: 'Godot Bridge', type: 'bridge', unreadCount: 0, status: 'online', icon: 'gamepad' },
...
export const NEO_AGENTS: NeoAgentStatus[] = [
  { id: 'agent-ai', name: 'AISupervisor', type: 'AISupervisor', status: 'idle', lastAction: 'Active' },
];
